...
public class LinkedHashMapDemo {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("It follows the insertion order of the key value pair in the LinkedHashMap. : " + data);
        ...
        System.out.println("Keys in the LinkedHashMap: " + data.keySet());//it will return all the keys in the hashmap.
        System.out.println("Values in the LinkedHashMap: " + data.values());//it will return all the values in the hashmap.
        // data.clear();//it will remove all the key value pair from the hashmap.
        System.out.println("Is the LinkedHashMap empty? " + data.isEmpty());//it will return true if the hashmap is empty otherwise it will return false.    
        ...
        System.out.println("Does the LinkedHashMap contain key 'dhiraj'? " + data.containsKey("dhiraj"));//it will return true if the key is present in the hashmap otherwise it will return false.
        System.out.println("Does the LinkedHashMap contain value 'gender'? " + data.containsValue("gender"));//it will return true if the value is present in the hashmap otherwise it will return false.
